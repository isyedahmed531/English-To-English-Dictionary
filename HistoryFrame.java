...
public class HistoryFrame extends javax.swing.JFrame {
    ...
    private void clearButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clearButtonMouseClicked
        ...
        new ClearRecords(true,false);
        statusResult.setText("  Status: History cleared successfully!  ");
        //
    ...
    public void updateTableByName() {
        try {
            String query = "SELECT date,word FROM history ORDER BY word ASC";
    ...
    public void updateTableByDate() {
        try {
            String query = "SELECT date,word FROM history ORDER BY date ASC";
            PreparedStatement pstmt = db.openDatabase().prepareStatement(query);
            ResultSet rs = pstmt.executeQuery();
            table.setModel(buildTableModel(rs));
        }
